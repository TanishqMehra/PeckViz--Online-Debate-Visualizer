...
export class RightSectionTaggingComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    let play_b = $('#play_btn')[0]
    play_b.setAttributeNS(null, 'isVideoPlaying', "false")
    // $('#play_btn').prop('isVideoPlaying', "false");
    $('#pause_btn').prop('disabled', true);
    let pause_b = $('#pause_btn')[0]
    pause_b.setAttributeNS(null, 'isVideoPlaying', "false")
    // $('#pause_btn').prop('isVideoPlaying', "false");
  ...
  playVideo(): void {
    // #('#play_btn').prop('isVideoPlaying') = true
    let play_b = $('#play_btn')[0],
    pause_b = $('#pause_btn')[0];
    if (play_b.getAttributeNS(null, 'isVideoPlaying') != "true"){
      play_b.setAttributeNS(null, 'isVideoPlaying', "true")
      this.playerElem = VideoObject.obj;
      this.playerElem.playVideo();
    }
    $('#play_btn').prop('disabled', true);
    $('#pause_btn').prop('disabled', false);
    pause_b.setAttributeNS(null, 'isVideoPlaying', "true")
    // $('#pause_btn').prop('isVideoPlaying', true)
    this.disableTaggingSection(true);
  ...
  pauseVideo(): void{
    ...
    let play_b = $('#play_btn')[0],
    pause_b = $('#pause_btn')[0];
    if (pause_b.getAttributeNS(null, 'isVideoPlaying') != "false"){
      pause_b.setAttributeNS(null, 'isVideoPlaying', "false")
      this.playerElem = VideoObject.obj;
